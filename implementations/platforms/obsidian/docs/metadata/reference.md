...
Reference notes describe stable information.
...
`relationships` is the Reference's Current Relationship Set: a list of
...
holds as a **source**: `Reference supports Project (0..*)` and
`Reference supports Resource (0..*)`. `supports` is conceptual, not
structural: it implies neither ownership nor lifecycle dependency.
Instance fields, identity, uniqueness, and
